...
case class HHompResult(
  ...
  def hitsOrderBy(params: DTParam): List[HHompHSP] = {
    (params.orderCol, params.orderDir) match {
      ...
      case (3, "asc")  => HSPS.sortBy(_.info.probabHit)
      case (3, "desc") => HSPS.sortWith(_.info.probabHit > _.info.probabHit)
      case (4, "asc")  => HSPS.sortBy(_.info.probabOMP)
      case (4, "desc") => HSPS.sortWith(_.info.probabOMP > _.info.probabOMP)
      ...
      case (7, "asc")  => HSPS.sortBy(_.info.alignedCols)
      case (7, "desc") => HSPS.sortWith(_.info.alignedCols > _.info.alignedCols)
