...
import de.proteinevolution.models.forwarding.{
  ForwardModalOptions,
  ForwardingError
}
...
@Singleton
class ForwardModalController @Inject()(
    cc: ControllerComponents,
    toolConfig: ToolConfig
) extends AbstractController(cc) {

  def getForwardModalOptions(
      modalType: String,
      toolName: String
    ...
    val options: Either[ForwardingError, ForwardModalOptions] =
      modalType match {
        case "normal" =>
          Right(
            ForwardModalOptions(
