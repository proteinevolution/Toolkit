    ...
    <div class="tool-finder-container mb-3">
        <div class="tool-finder container">
            <b-row class="live-table">
                    ...
                    <div class="live-table-child">
                        <div class="load-bar">
                            ...
                            <div class="load-bar-graph">
                                <div :class="[clusterWorkload > 0 ? 'green' : '']" class="load-bar-segment"></div>
                                <div :class="[clusterWorkload > 25 ? 'green' : '']" class="load-bar-segment"></div>
                                <div :class="[clusterWorkload > 50 ? 'green' : '']" class="load-bar-segment"></div>
                                <div :class="[clusterWorkload > 75 ? 'green' : '']" class="load-bar-segment"></div>
                            </div>
                        </div>
                    </div>
                </b-col>
                <b-col cols="6">
                    <div class="live-table-child">
                        <router-link class="job-manager-link" to="/jobmanager">
            ...
            <b-row class="search-container">
                <b-col :class="'status-' + currentJobStatus" class="traffic-bar" cols="12" @click="goToCurrentJob" />
                <b-col class="search-field-container" cols="12">
                    <SearchField data-v-step="search-bar" :placeholder="$t('index.searchPlaceholder')" />
                </b-col>
            </b-row>
        </div>
    </div>
    ...
    methods: {
        animateClusterload(end: number, duration = 10): void {
            ...
            const timer = setInterval(() => {
                ...
                if (
                    this.clusterWorkload === Math.floor(end * 100) ||
                    this.clusterWorkload <= 0 ||
