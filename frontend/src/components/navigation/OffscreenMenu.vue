<template>
    <div id="offscreenMenu" class="offscreen-menu-wrapper">
        <transition name="fade">
            <div v-if="isOpen" class="offscreen-backdrop" @click="close"></div>
        </transition>
        <transition name="slide">
            <div v-if="isOpen" class="offscreen-menu">
                ...
                <span class="offscreen-menu-close" @click="close"> &times; </span>
            </div>
        </transition>
    </div>
</template>
