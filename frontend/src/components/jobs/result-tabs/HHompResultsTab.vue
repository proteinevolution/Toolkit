                        ...
                        <tbody>
                            <template v-for="(al, i) in alignments" :key="'rows-' + al.num">
                                ...
                                <template
                                    ...
                                    <tr v-if="alPart.query.ss_conf" class="sequence">
                                        <td></td>
                                        <td>Q ss_conf</td>
                                        <td></td>
                                        <td v-html="alPart.query.ss_conf"></td>
                                    </tr>
                                    <tr v-if="alPart.query.ss_dssp" class="sequence">
                                        <td></td>
                                        <td>Q ss_pred</td>
                                        <td></td>
                                    ...
                                    <tr v-if="alPart.template.ss_conf" class="sequence">
                                        <td></td>
                                        <td>T ss_conf</td>
                                        <td></td>
                                        <td v-text="alPart.template.ss_conf"></td>
                                    </tr>
                                    <tr v-if="alPart.template.bb_pred" class="sequence">
                                        <td></td>
                                        <td>T bb_pred</td>
                                        <td></td>
                                        <td v-text="alPart.template.bb_pred"></td>
                                    </tr>
                                    <tr v-if="alPart.template.bb_conf" class="sequence">
                                        <td></td>
                                        <td>T bb_conf</td>
                                        <td></td>
...
const hitListFields = [
    {
        key: 'num',
        label: t('jobs.results.hhomp.table.num'),
        sortable: true,
    },
    {
        key: 'acc',
        label: t('jobs.results.hhomp.table.hit'),
        sortable: true,
    },
    {
        key: 'name',
        label: t('jobs.results.hhomp.table.name'),
        sortable: true,
    },
    {
        key: 'probabHit',
        label: t('jobs.results.hhomp.table.probHits'),
        sortable: true,
    },
    {
        key: 'probabOMP',
        label: t('jobs.results.hhomp.table.probOMP'),
        sortable: true,
    },
    {
        key: 'eval',
        label: t('jobs.results.hhomp.table.eVal'),
        class: 'no-wrap',
        sortable: true,
    },
    {
        key: 'ssScore',
        label: t('jobs.results.hhomp.table.ssScore'),
        sortable: true,
    },
    {
        key: 'alignedCols',
        label: t('jobs.results.hhomp.table.cols'),
        sortable: true,
    },
    {
        key: 'templateRef',
        label: t('jobs.results.hhomp.table.targetLength'),
        sortable: true,
    },
];
</script>
