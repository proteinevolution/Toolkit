...
import {
    ...
    booleanParameter,
    dnaSequenceParameter, dnaSequenceValidationParams, fastaHeaderParameter, fastaHeaderValidationParams,
    multiSelectParameter, pdbParameter,
    proteinSequenceParameter, proteinSequenceValidationParams, reformatView,
    regexParameter,
    singleSelectParameter,
} from './exampleParams';
import {AlignmentSeqFormat, AlignmentSeqType} from '../types/toolkit/enums';
    ...
    private static tools: Tool[] = [
        {
            ...
            validationParams: proteinSequenceValidationParams,
        ...
        },
        {
            ...
            validationParams: dnaSequenceValidationParams,
            showSubmitButtons: true,
            parameters: undefined,
        },
        {
        ...
        },
        {
            ...
            validationParams: fastaHeaderValidationParams,
            showSubmitButtons: true,
            parameters: undefined,
        },
        {
