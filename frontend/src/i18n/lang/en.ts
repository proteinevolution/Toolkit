    ...
    en: {
        ...
        tools: {
            ...
            validation: {
                ...
                maxSeqNumber: 'Input contains more than ... sequences!',
                minSeqNumber: 'Input contains less than ... sequences!',
                maxSeqLength: 'Input exceeds maximum allowed sequence length of ...!',
                minSeqLength: 'Minimum allowed sequence length is ...!',
                onlyDashes: 'Sequence contains only dots/dashes!',
                sameLength: 'Invalid MSA! Sequences should have the same length.',
                maxLength: 'Input contains over ... characters!',
