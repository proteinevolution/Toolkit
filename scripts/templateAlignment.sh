...
then
    ...
    ffindex_get ${scopdir}_a3m.ffdata ${scopdir}_a3m.ffindex $accession >> results/$number.a3m
    ffindex_get ${mmcifdir}_a3m.ffdata ${mmcifdir}_a3m.ffindex $accession >> results/$number.a3m
    ffindex_get ${pfamdir}_a3m.ffdata ${pfamdir}_a3m.ffindex "$accession.a3m" >> results/$number.a3m
    ffindex_get ${escherichia_coli}_a3m.ffdata ${escherichia_coli}_a3m.ffindex "$accession" >> results/$number.a3m
    ffindex_get ${escherichia_coli}_a3m.ffdata ${escherichia_coli}_a3m.ffindex "$accession" >> results/$number.a3m
    ffindex_get results/db_a3m.ffdata results/db_a3m.ffindex "db.a3m" >> results/$number.a3m
    ffindex_get ${saccharomyces}_a3m.ffdata ${saccharomyces}_a3m.ffindex "$accession" >> results/$number.a3m
