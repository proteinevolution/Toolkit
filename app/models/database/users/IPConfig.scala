...
object IPConfig {
  ...
  final val sessionsMax        : Int = Int.MaxValue - 1 // TODO we may need to limit the amount of sessions, but at the same time we need to reset them again - so a good limit has to be found
