...
window.JobListComponent = {
    ...
    getJob: function(jobID: string): any {
        let foundJob = null;
        JobListComponent.list.map(function(job: any) {
            if (job.jobID === jobID) foundJob = job;
        });
        return foundJob;
    },
    ...
    getJobIndex: function(jobID: string): any {
        let foundIndex = null;
        JobListComponent.list.map(function(job: any, index: number) {
    ...
    jobIDs: function(): Array<string> {
        return JobListComponent.list.map(function(job: any) {
            return job.jobID;
        });
    },
    ...
    sortList: function(sortMode?: string, reverse?: boolean): boolean {      // Sorting the list elements
        ...
        JobListComponent.visibleJobs().map(function(job: any) {
            if (job.jobID === selectedJobID) selectedInView = true;
        });
        // Sort the list
    ...
    controller: function(args: any) {
        ...
        JobListComponent.controller = function() {
            return {};
        };
        return {};
    },
    view: function(ctrl: any, args: any) {
        let shownList: any, listLength: any, listTooLong: any, onTopOfList: any, onBottomOfList: any,
            numScrollItems: any, page: any, pagesTotal: any;
        ...
        return m("div", {"class": "job-list", config: tooltipConf}, [
            ...
            m("div", {"class": "elements noselect"}, [
                ...
                shownList.map(function(job: any) {
